% Aprendizagem Computacional, Computação Neuronao e Sistems Difusos, DEI,
% 2016.
...
% oO resultado da "digitalização" da quadrícula é armazenado na estrutura
...
%Resumindo:
% 1º Corre-se mpaper (sem fazer classificação, comentando a linha feval nº 192 neste ficheiro)
...
% activando as linhas 180 a 185 e desactivando a linha 201 e 202.
% 
...
% o botão central do rato, quqndo não existe, pode ser substituído pela
...
function Dn(varargin)
 ...
 % to save P; for that we must write
              ...
              %temp=load('temp.mat','-mat');
              %P=horzcat(temp.P1, temp.P2, temp.P3, temp.P4, temp.P5, temp.P6, temp.P7, temp.P8, temp.P9, temp.P0);
